...
export default async function BlogPost({ params }: Props) {
  ...
  return (
    <article className="max-w-[680px] w-full mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert prose-gray max-w-none font-[family-name:var(--font-spectral)] leading-[1.75]">
